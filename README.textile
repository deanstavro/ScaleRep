...
2. Create the necessary user and database on your local postgres database
...
1. To build the example application, Rails 5.0 must be installed in your development environment. Run the command:
2. $ rails new scalerep -m https://raw.github.com/RailsApps/rails-composer/master/composer.rb. This creates a new Rails app named scalerep on your computer. You can use a different name if you wish.
